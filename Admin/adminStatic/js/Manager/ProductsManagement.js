        ...
        data.products.forEach((product, index) => {
            content += `
                <tr>
                    ...
                    <td>${product.price}</td>
                    <td>                        
                        <button class='btn btn-datatable btn-icon btn-transparent-dark' onclick="viewImageProduct('/media/${product.image}')"><i class="fa-regular fa-eye"></i></button>
                    </td>
                    <td>
                        <button class='btn btn-datatable btn-icon btn-transparent-dark me-2' onclick="updateProducts(
                            ${product.id},
                            '${product.Product}',
                        ...
                        <button class='btn btn-datatable btn-icon btn-transparent-dark' onclick="deleteProducts('${product.id}')"><i class='fa-regular fa-trash-can' ></i></button>
                    </td>
                </tr>`;
        });
...
const viewListProducts = async () => {
    ...
    const dataTableOptions = {
        ...
        language: {
            ...
            //Activamos el scrollX para que aparezca el scroll horizontal
            scrollX: true,
