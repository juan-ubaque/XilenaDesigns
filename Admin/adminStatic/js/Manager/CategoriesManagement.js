        ...
        data.categories.forEach((categories, index) => {
            content += `
                <tr>
                    ...
                    <td>
                        <button class='btn btn-datatable btn-icon btn-transparent-dark' onclick="updateCategories('Agregar Categoria',${categories.id},'${categories.name_categories}')"><i class='fa-solid fa-pencil'></i></button>
                        <button class='btn btn-datatable btn-icon btn-transparent-dark' onclick="deleteCategories('${categories.id}')"><i class='fa-solid fa-trash-can' ></i></button>
                    </td>
                </tr>`;
        });
...
//            { className: "centered", targets: [0, 1, 2,3] },//centrar contenido de las columnas
            { orderable: false, targets: [0,3] },//no se puede ordenar por ..
            { searchable: false, targets: [0,3 ] }//no se puede buscar por...
        ],
        pageLength: 4,
        destroy: true,
        language: {
